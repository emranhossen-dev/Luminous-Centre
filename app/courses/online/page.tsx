      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight">
            Online <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2F2FE4] to-[#60a5fa]">Live Courses</span>
          </h1>
          <p className="text-gray-400 max-w-2xl text-lg mx-auto mt-4">
            Join our interactive online live classes and learn directly from industry experts in real-time.
          </p>
        </div>

        {/* Category Switcher */}
        <CategorySwitcher currentCategory="online" />
        
        <DynamicCourses category="online" />
      </div>
    </main>
  );
}
