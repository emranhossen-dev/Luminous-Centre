    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="relative glass rounded-[4rem] p-12 md:p-24 border-white/5 overflow-hidden text-center space-y-10 group">
          ...
          >
            <button className="px-12 py-6 bg-[#2F2FE4] hover:bg-[#162E93] text-white rounded-[2rem] font-black text-xl transition-all transform active:scale-95 flex items-center gap-4 group shadow-[0_0_50px_rgba(47,47,228,0.4)]">
              Enroll Now
