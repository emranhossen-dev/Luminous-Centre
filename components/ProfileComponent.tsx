...
export default function ProfileComponent() {
  ...
  // Handle Save Dashboard & Notification Preferences
  const handleSavePreferences = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error(data.error || 'Failed to update preference settings');
      }
    } catch (err) {
      toast.error('Failed to connect to system endpoints.');
    } finally {
  ...
  return (
    <div className="text-slate-100 font-sans w-full max-w-6xl mx-auto space-y-8">
      <ToastContainer position="top-right" autoClose={3000} theme="dark" />
      
      {/* Title Area */}
      <div>
        <h1 className="text-3xl font-black tracking-tight mb-2 text-white">My Profile</h1>
        <p className="text-slate-400 text-sm">Manage your account information and preferences.</p>
      </div>

      {/* Top Profile Card */}
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl flex flex-col md:flex-row gap-8 items-center">
        {/* Avatar Area */}
        <div className="flex flex-col items-center gap-3">
          <div className="w-28 h-28 rounded-full bg-gradient-to-r from-emerald-500 to-blue-600 border border-slate-800 flex items-center justify-center text-white font-extrabold text-4xl shadow-lg relative overflow-hidden group">
            {avatarUrl ? (
          ...
          <button
            ...
            className="text-xs font-bold text-emerald-400 hover:text-emerald-350 transition-colors cursor-pointer"
          >
            Change Photo
          </button>
        </div>
        ...
        <div className="flex-1 text-center md:text-left space-y-2">
          ...
          <p className="text-slate-400 text-sm font-bold tracking-wide uppercase">{designation || 'Learning Hub Member'}</p>
          
          <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 pt-2 text-sm text-slate-400">
      ...
      {/* Tab Navigation Menu */}
      <div className="flex flex-wrap border-b border-slate-800 gap-1 overflow-x-auto">
        {[
              ...
              <form onSubmit={handleSaveProfile} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-slate-955 border border-slate-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/30 text-sm text-white placeholder-slate-700 transition-all"
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      disabled
                      value={email}
                      className="w-full px-4 py-2.5 bg-slate-955 border border-slate-800 rounded-xl opacity-60 text-sm text-slate-500 cursor-not-allowed"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-4 py-2.5 bg-slate-955 border border-slate-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/30 text-sm text-white transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2.5 bg-slate-955 border border-slate-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/30 text-sm text-white transition-all"
                    >
                  ...
                  <div className="space-y-2 md:col-span-2">
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Designation / Title</label>
                    <input
                      type="text"
                      value={designation}
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        className="w-full pl-11 pr-4 py-2.5 bg-slate-955 border border-slate-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/30 text-sm text-white placeholder-slate-700 transition-all"
                        placeholder="House, Road, Sector, Area, City"
                      />
                    </div>
                  </div>

                  {/* Biography / Skills (Only show for mentors) */}
                  {roleName === 'mentor' && (
                    <>
                      <div className="space-y-2 md:col-span-2">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Expert Skills (comma-separated)</label>
                        <input
                          type="text"
                          value={skills}
                      ...
                      <div className="space-y-2 md:col-span-2">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Biography / Professional Profile</label>
                        <textarea
                          rows={4}
                          value={bio}
                ...
                <div className="border-t border-slate-850 pt-6 flex justify-end">
                  <button
                    ...
                    className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white font-bold text-sm rounded-xl shadow-md transition-all active:scale-95 duration-200 cursor-pointer"
                  >
            ...
            <div className="space-y-8">
                ...
                <form onSubmit={handleChangePassword} className="space-y-6">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-12 py-2.5 bg-slate-955 border border-slate-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/30 text-sm text-white placeholder-slate-750 transition-all"
                        placeholder="••••••••"
                      />
                      <button
                        type="button"
                  ...
                  <div className="border-t border-slate-850 pt-6 flex justify-end">
                    <button
                      ...
                      className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white font-bold text-sm rounded-xl shadow-md transition-all active:scale-[0.98] duration-200 cursor-pointer"
                    >
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-xs font-bold text-slate-400">{twoFactor ? 'ENABLED' : 'DISABLED'}</span>
                  <button
                    onClick={() => {
                      setTwoFactor(!twoFactor);
                      toast.info(`Two-Factor Authentication has been simulated as ${!twoFactor ? 'enabled' : 'disabled'}.`);
                    }}
                    className={`relative w-12 h-6 rounded-full transition-colors duration-200 focus:outline-none ${
                      twoFactor ? 'bg-emerald-500' : 'bg-slate-850'
                    }`}
                  >
                    <span
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl">
                <div className="border-b border-slate-800 pb-4 mb-4">
                  ...
                  <p className="text-slate-400 text-sm">Devices currently logged in to your account.</p>
                </div>

                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-slate-955 border border-slate-800 rounded-2xl">
                    ...
                    <span className="px-2.5 py-0.5 bg-emerald-500/15 text-emerald-400 border border-emerald-500/20 text-[10px] font-bold rounded-full uppercase">
                      Current
                    </span>
                  </div>

                  <div className="flex items-center justify-between p-4 bg-slate-955 border border-slate-800 rounded-2xl opacity-75">
                    <div className="flex items-center gap-4">
              ...
              <div className="space-y-6 divide-y divide-slate-800">
                ...
                <div className="flex items-center justify-between pt-4 first:pt-0">
                  ...
                  <button
                    ...
                    className={`relative w-12 h-6 rounded-full transition-colors duration-200 focus:outline-none shrink-0 ${
                      notificationsEmail ? 'bg-emerald-500' : 'bg-slate-850'
                    }`}
                  >
                    <span
                      className={`absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform duration-200 ${
                ...
                <div className="flex items-center justify-between pt-6">
                  ...
                  <button
                    ...
                    className={`relative w-12 h-6 rounded-full transition-colors duration-200 focus:outline-none shrink-0 ${
                      notificationsSms ? 'bg-emerald-500' : 'bg-slate-850'
                    }`}
                  >
                    <span
                      className={`absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform duration-200 ${
                ...
                <div className="flex items-center justify-between pt-6">
                  ...
                  <button
                    ...
                    className={`relative w-12 h-6 rounded-full transition-colors duration-200 focus:outline-none shrink-0 ${
                      notificationsCourseUpdates ? 'bg-emerald-500' : 'bg-slate-850'
                    }`}
                  >
                    <span
                      className={`absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform duration-200 ${
                ...
                <div className="flex items-center justify-between pt-6">
                  ...
                  <button
                    ...
                    className={`relative w-12 h-6 rounded-full transition-colors duration-200 focus:outline-none shrink-0 ${
                      notificationsMarketing ? 'bg-emerald-500' : 'bg-slate-850'
                    }`}
                  >
                    <span
                      className={`absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform duration-200 ${
          ...
          {activeTab === 'preferences' && (
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* Timezone */}
                <div className="space-y-2">
                  <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">System Timezone</label>
                  <div className="relative">
                ...
                {/* Theme */}
                <div className="space-y-2 md:col-span-2">
                  <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Portal Theme Mode</label>
                  <select
                    value={theme}
                    onChange={(e) => {
          ...
          {activeTab === 'activity' && (
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl">
              <div className="border-b border-slate-800 pb-4 mb-6">
                ...
                <p className="text-slate-400 text-sm">Security auditing audit logs for your account actions.</p>
              </div>

              {activities.length === 0 ? (
                <p className="text-slate-500 text-sm text-center py-6">No recent actions recorded.</p>
              ) : (
                <div className="relative pl-6 border-l-2 border-slate-800 space-y-8 py-2">
                  {activities.map((act) => (
                    <div key={act.id} className="relative">
                      {/* Circle Bullet */}
                      <div className="absolute w-3.5 h-3.5 bg-emerald-500 border-4 border-slate-905 rounded-full -left-[27px] top-1" />
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-slate-550 font-bold uppercase mt-2 block tracking-wider">
