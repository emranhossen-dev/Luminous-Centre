...
export default function Navbar() {
  ...
  // Load theme from localStorage on client-side mount, default = light
  useEffect(() => {
    ...
    <>
      ...
      <nav className={`fixed top-0 w-full z-50 transition-colors duration-300 ${theme === 'dark'
        ...
        <div className="w-full px-4 md:px-8 lg:px-12 xl:px-16 h-16 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            <NavLink href="/" label="Home" theme={theme} />
            <div
            ...
            <NavLink href="/contact" label="Contact" theme={theme} />
          </div>
      ...
      >
        ...
        <div className="p-4 flex flex-col gap-4 text-sm">
          ...
          <Link href="/" className="hover:text-[#2e31e1] transition-colors text-white" onClick={() => setSidebar(false)}>Home</Link>
          ...
          <Link href="/contact" className="hover:text-[#2e31e1] transition-colors text-white" onClick={() => setSidebar(false)}>Contact</Link>
